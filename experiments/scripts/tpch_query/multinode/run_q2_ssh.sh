...
cargo build --release --package experiments --bin q2 --features tcp
scp target/release/q2 $USER1@$HOST1:$PROJECT_PATH/target/release/
scp target/release/q2 $USER2@$HOST2:$PROJECT_PATH/target/release/
