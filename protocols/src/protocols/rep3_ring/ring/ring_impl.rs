...
impl<T: IntRing2k> RingElement<T> {
    ...
    ///Qamboo: create
    pub fn get_bit_for_perm(&self, index: usize) -> bool {
        ((self.0 >> index) & T::one())== T::one()
    }
...
impl<T: IntRing2k> Div<T> for RingElement<T> {
    type Output = Self;
...
impl<T: IntRing2k> Div for RingElement<T> {
    type Output = Self;
...
impl<T: IntRing2k> Div<&Self> for RingElement<T> {
    type Output = Self;
...
impl<T: IntRing2k> DivAssign for RingElement<T> {
    fn div_assign(&mut self, rhs: Self) {
        self.0 = self.0 / rhs.0;
    }
}

impl<T: IntRing2k> DivAssign<&Self> for RingElement<T> {
    fn div_assign(&mut self, rhs: &Self) {
        self.0 = self.0 / rhs.0;
    }
}

impl<T: IntRing2k> DivAssign<T> for RingElement<T> {
...
impl<T: IntRing2k> Rem for RingElement<T> {
    type Output = Self;
...
impl<T: IntRing2k> Rem<&Self> for RingElement<T> {
    type Output = Self;
...
impl<T: IntRing2k> RemAssign for RingElement<T> {
    fn rem_assign(&mut self, rhs: Self) {
        self.0 = self.0 % rhs.0;
    }
}

impl<T: IntRing2k> RemAssign<&Self> for RingElement<T> {
    fn rem_assign(&mut self, rhs: &Self) {
        self.0 = self.0 % rhs.0;
    }
}

impl<T: IntRing2k> RemAssign<T> for RingElement<T> {
