...
BIN_PATH="smc_run ./target/release/q10_no_join_reorder"
...
RUSTFLAGS="-C target-cpu=native" cargo build --release --package experiments --bin q10_no_join_reorder --features tcp
scp target/release/q10_no_join_reorder $HOST1:$PROJECT_PATH/target/release/
scp target/release/q10_no_join_reorder $HOST2:$PROJECT_PATH/target/release/
