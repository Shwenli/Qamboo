...
BIN_PATH="smc_run ./target/release/q9_no_join_reorder"
...
scp target/release/q9_no_join_reorder $HOST1:$PROJECT_PATH/target/release/
scp target/release/q9_no_join_reorder $HOST2:$PROJECT_PATH/target/release/
