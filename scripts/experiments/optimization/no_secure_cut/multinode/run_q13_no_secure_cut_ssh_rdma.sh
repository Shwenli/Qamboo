...
BIN_PATH="smc_run ./target/release/q13_no_secure_cut"
...
RUSTFLAGS="-C target-cpu=native" cargo build --release --package experiments --bin q13_no_secure_cut --features tcp
scp target/release/q13_no_secure_cut $HOST1:$PROJECT_PATH/target/release/
scp target/release/q13_no_secure_cut $HOST2:$PROJECT_PATH/target/release/
