...
BIN_PATH="smc_run ./target/release/q3_no_secure_cut"
...
scp target/release/q3_no_secure_cut $HOST1:$PROJECT_PATH/target/release/
scp target/release/q3_no_secure_cut $HOST2:$PROJECT_PATH/target/release/
