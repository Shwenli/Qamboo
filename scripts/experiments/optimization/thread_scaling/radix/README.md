...
```bash
cd scripts/experiments/optimization/thread_scaling/radix
./run_radix_thread_scaling.sh <SHIFT> [-h1 HOST1] [-h2 HOST2]
```
...
./run_radix_thread_scaling.sh 24 -h1 192.168.1.11 -h2 192.168.1.12
```
