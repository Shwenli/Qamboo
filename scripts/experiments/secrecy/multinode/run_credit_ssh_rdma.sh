#!/bin/bash
#! run with: ./run_credit_ssh_rdma.sh 4 0.01
...
BIN_PATH="smc_run ./target/release/credit"
...
scp target/release/credit $HOST1:$PROJECT_PATH/target/release/
scp target/release/credit $HOST2:$PROJECT_PATH/target/release/
