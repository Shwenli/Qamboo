#!/bin/bash
#! run with: ./run_rcdiff_ssh_rdma.sh 4 0.01
...
BIN_PATH="smc_run ./target/release/rcdiff"
...
scp target/release/rcdiff $HOST1:$PROJECT_PATH/target/release/
scp target/release/rcdiff $HOST2:$PROJECT_PATH/target/release/
