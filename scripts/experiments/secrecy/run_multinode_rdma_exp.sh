...
# Goal: .../experiments/result/secrecy_query/multinode/stat_output_rdma.log
LOG_FILE="$CURRENT_DIR/../../../experiments/result/secrecy_query/multinode/stat_output_rdma.log"
...
for query in "${QUERY_LIST[@]}"; do
    SCRIPT_NAME="run_${query}_ssh_rdma.sh"
    SCRIPT_PATH="$MULTINODE_SCRIPT_DIR/$SCRIPT_NAME"

    echo ""
    echo ">>> Running Secrecy Query '$query' (Multinode RDMA) ..."
...
echo ""
echo "============================================================"
echo "All Secrecy Multinode RDMA Experiments Completed."
echo "============================================================"
