...
BIN_PATH="smc_run ./target/release/q11"
...
# Build q11 binary and copy to remote hosts
RUSTFLAGS="-C target-cpu=native" cargo build --release --package experiments --bin q11 --features tcp
scp target/release/q11 $HOST1:$PROJECT_PATH/target/release/
scp target/release/q11 $HOST2:$PROJECT_PATH/target/release/
