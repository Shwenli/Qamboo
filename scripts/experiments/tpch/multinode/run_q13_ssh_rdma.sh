...
BIN_PATH="smc_run ./target/release/q13"
...
# Build q13 binary and copy to remote hosts
RUSTFLAGS="-C target-cpu=native" cargo build --release --package experiments --bin q13 --features tcp
scp target/release/q13 $HOST1:$PROJECT_PATH/target/release/
scp target/release/q13 $HOST2:$PROJECT_PATH/target/release/
