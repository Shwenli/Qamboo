...
BIN_PATH="smc_run ./target/release/q14"
...
# Build q14 binary and copy to remote hosts
RUSTFLAGS="-C target-cpu=native" cargo build --release --package experiments --bin q14 --features tcp
scp target/release/q14 $HOST1:$PROJECT_PATH/target/release/
scp target/release/q14 $HOST2:$PROJECT_PATH/target/release/
