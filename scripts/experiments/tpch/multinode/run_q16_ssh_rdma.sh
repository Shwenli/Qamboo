...
BIN_PATH="smc_run ./target/release/q16"
...
# Build q16 binary and copy to remote hosts
RUSTFLAGS="-C target-cpu=native" cargo build --release --package experiments --bin q16 --features tcp
scp target/release/q16 $HOST1:$PROJECT_PATH/target/release/
scp target/release/q16 $HOST2:$PROJECT_PATH/target/release/
