...
BIN_PATH="smc_run ./target/release/q20"
...
# Build q20 binary and copy to remote hosts
RUSTFLAGS="-C target-cpu=native" cargo build --release --package experiments --bin q20 --features tcp
scp target/release/q20 $HOST1:$PROJECT_PATH/target/release/
scp target/release/q20 $HOST2:$PROJECT_PATH/target/release/
