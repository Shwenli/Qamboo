...
BIN_PATH="smc_run ./target/release/q5"
...
# Build q5 binary and copy to remote hosts
RUSTFLAGS="-C target-cpu=native" cargo build --release --package experiments --bin q5 --features tcp
scp target/release/q5 $HOST1:$PROJECT_PATH/target/release/
